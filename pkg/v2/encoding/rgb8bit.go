...
type rgb8BitReader struct { }

func newRGB8BitReader() *rgb8BitReader {
    return &rgb8BitReader{}
}

func (r *rgb8BitReader) read(buffer []byte, offset int) (uint, int) {
    return uint(buffer[offset]), offset + 1
}

func (r *rgb8BitReader) write(buffer []byte, offset int, color *ansi.Rgb) int {
