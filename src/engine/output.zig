...
const GameStateJSON = struct {
    ...
    cols: usize,
    allowedTowers: isize,
    yourCreepDamage: usize,
    enemyCreepDamage: usize,
    yourTowers: []TowerValue,
    enemyTowers: []TowerValue,
    towerPlacementRange: math.Range,
    creepSpawnRange: math.Range,
    round: usize,
    playing: bool,
    finished: bool,
    winner: u8,
...
fn fromGameState(gs: *GS, oneTowers: *TowerList, twoTowers: *TowerList) !GameStateJSON {
    ...
    return .{
        ...
        .yourCreepDamage = gs.twoCreepDamage,
        .enemyCreepDamage = gs.oneCreepDamage,
        .yourTowers = oneTowers.items,
        .enemyTowers = twoTowers.items,
        .towerPlacementRange = gs.twoNoBuildTowerRange,
        .creepSpawnRange = gs.twoCreepRange,
        .round = gs.round,
        .playing = gs.playing,
